 ...
 */
public class AllOptCustMatch implements Verifiable {

    public static final SemanticVersion VERSION = SemanticVersion.parse("1.0.0");

    private static final java.util.regex.Pattern REGEX___1___ = // what
        java.util.regex.Pattern.compile("^some\\s+stuff$");
    ...
    */
    @SuppressWarnings("EqualsWhichDoesntCheckParameterClass") @Override public boolean equals(Object other) {
        return Objects.deepEquals(new Object[]{this.counter, this.what, this.when},
          new Object[]{((AllOptCustMatch) other).counter, ((AllOptCustMatch) other).what, ((AllOptCustMatch) other).when});
    }
    ...
    public void verify() {
        ...
        if(what != null && !REGEX___1___.matcher(what).matches())
            throw new VerificationException("Variable \"what\" == {{" + what + "}} didn't match custom expression {{" + REGEX___1___ + "}}");
